...
//2 G1生成元配置错误
//3 G2生成元配置错误
int SM9_Init(unsigned int curve, int TWIST_TYPE, unsigned int seclevel, unsigned char *t, unsigned char *q,
...
//2 G1生成元配置错误
//3 G2生成元配置错误
int SM9_Encrypt(unsigned char *mes, unsigned int meslen, unsigned int KDF_ID, unsigned char *ran, SM9_PK *pk,
                SM9_Cipher *cip);
...
//3 G2生成元配置错误
int
SM9_Decrypt(SM9_PK *pk, unsigned int KDF_ID, SM9_CSK *sk, SM9_Cipher *cip, unsigned char *mes, unsigned int *meslen);
...
//3 G2生成元配置错误
int
SM9_ReceiveStep(unsigned char *ran, SM9_Send *S, SM9_Send *R, SM9_PK *SP, SM9_PK *RP, SM9_KSK *ksk, unsigned int sklen,
                unsigned char *S1, unsigned char *S2, unsigned char *SK, unsigned int SorR);
