...
char ct[32] = {
        "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x60\x00\x00\x00\x00\x58\xF9\x8A"};

// 基域特征 q = B6400000 02A3A6F1 D603AB4F F58EC745 21F2934B 1A7AEEDB E56F9B27 E351457D
char cq[32] = {
        "\xB6\x40\x00\x00\x02\xA3\xA6\xF1\xD6\x03\xAB\x4F\xF5\x8E\xC7\x45\x21\xF2\x93\x4B\x1A\x7A\xEE\xDB\xE5\x6F\x9B\x27\xE3\x51\x45\x7D"};
...
// 群G1 G2的阶 N = B6400000 02A3A6F1 D603AB4F F58EC744 49F2934B 18EA8BEE E56EE19C D69ECF25
char cn[32] = {
        "\xB6\x40\x00\x00\x02\xA3\xA6\xF1\xD6\x03\xAB\x4F\xF5\x8E\xC7\x44\x49\xF2\x93\x4B\x18\xEA\x8B\xEE\xE5\x6E\xE1\x9C\xD6\x9E\xCF\x25"};
// G1 生成元 g1_x = 93DE051D 62BF718F F5ED0704 487D01D6 E1E40869 09DC3280 E8C4E481 7C66DDDD
char cxp1[32] = {
        "\x93\xDE\x05\x1D\x62\xBF\x71\x8F\xF5\xED\x07\x04\x48\x7D\x01\xD6\xE1\xE4\x08\x69\x09\xDC\x32\x80\xE8\xC4\xE4\x81\x7C\x66\xDD\xDD"};
// G1 生成元 g1_y = 21FE8DDA 4F21E607 63106512 5C395BBC 1C1C00CB FA602435 0C464CD7 0A3EA616
char cyp1[32] = {
        "\x21\xFE\x8D\xDA\x4F\x21\xE6\x07\x63\x10\x65\x12\x5C\x39\x5B\xBC\x1C\x1C\x00\xCB\xFA\x60\x24\x35\x0C\x46\x4C\xD7\x0A\x3E\xA6\x16"};
// G2 生成元 g2_x_x = 37227552 92130B08 D2AAB97F D34EC120 EE265948 D19C17AB F9B7213B AF82D65B
char cxq1[32] = {
        "\x37\x22\x75\x52\x92\x13\x0B\x08\xD2\xAA\xB9\x7F\xD3\x4E\xC1\x20\xEE\x26\x59\x48\xD1\x9C\x17\xAB\xF9\xB7\x21\x3B\xAF\x82\xD6\x5B"};
// G2 生成元 g2_x_y = 85AEF3D0 78640C98 597B6027 B441A01F F1DD2C19 0F5E93C4 54806C11 D8806141
char cxq2[32] = {
        "\x85\xAE\xF3\xD0\x78\x64\x0C\x98\x59\x7B\x60\x27\xB4\x41\xA0\x1F\xF1\xDD\x2C\x19\x0F\x5E\x93\xC4\x54\x80\x6C\x11\xD8\x80\x61\x41"};
// G2 生成元 g2_y_x = A7CF28D5 19BE3DA6 5F317015 3D278FF2 47EFBA98 A71A0811 6215BBA5 C999A7C7
char cyq1[32] = {
        "\xA7\xCF\x28\xD5\x19\xBE\x3D\xA6\x5F\x31\x70\x15\x3D\x27\x8F\xF2\x47\xEF\xBA\x98\xA7\x1A\x08\x11\x62\x15\xBB\xA5\xC9\x99\xA7\xC7"};
// G2 生成元 g2_y_y = 17509B09 2E845C12 66BA0D26 2CBEE6ED 0736A96F A347C8BD 856DC76B 84EBEB96
char cyq2[32] = {
        "\x17\x50\x9B\x09\x2E\x84\x5C\x12\x66\xBA\x0D\x26\x2C\xBE\xE6\xED\x07\x36\xA9\x6F\xA3\x47\xC8\xBD\x85\x6D\xC7\x6B\x84\xEB\xEB\x96"};
//
char sm9Xx[32] = {
        "\x3f\x23\xea\x58\xe5\x72\x0b\xdb\x84\x3c\x6c\xfa\x9c\x08\x67\x49\x47\xc5\xc8\x6e\x0d\xdd\x04\xed\xa9\x1d\x83\x54\x37\x7b\x69\x8b"};
//================================

int SM9_Init(unsigned int curve, BOOL TWIST_TYPE, unsigned int seclevel, unsigned char *t, unsigned char *q,
             unsigned char *a, unsigned char *b, unsigned char *n, unsigned char *xp1, unsigned char *yp1,
             unsigned char *xq1, unsigned char *xq2, unsigned char *yq1, unsigned char *yq2) {
...
unsigned char *
SM9_Set_Sign(unsigned char *x1, unsigned char *x2, unsigned char *y1, unsigned char *y2, unsigned char *gGtchar) {
    miracl *mr_mip;
    big x, y;
    zzn2 xx, yy;
    unsigned char *gc;
